 ...
 */
 (function($) {
            ...
            return this.each(function() {
                ...
                if (_4) {
                    ...
                    _4 = $.data(this, "navpanel", {
                        options: $.extend({},
                        $.fn.navpanel.defaults, $.fn.navpanel.parseOptions(this, _1))
                    });
    ...
    $.fn.navpanel.parseOptions = function(_5) {
        return $.extend({},
        $.fn.panel.parseOptions(_5), $.parser.parseOptions(_5, []));
 ...
 (function($) {
    ...
    $.mobile = {
        ...
        init: function(_6) {
            ...
            $(document).unbind(".mobile").bind("click.mobile", 
            function(e) {
            ...
            $(window).unbind(".mobile").bind("hashchange.mobile", 
            function() {
        ...
        nav: function(_c, to, _d, _e) {
            if (window.WebKitAnimationEvent) {
                ...
                p1.add(p2).bind("webkitAnimationEnd", 
                function() {
    ...
    $.map(["spinner", "numberspinner", "timespinner", "datetimespinner"], 
    function(_1a) {
