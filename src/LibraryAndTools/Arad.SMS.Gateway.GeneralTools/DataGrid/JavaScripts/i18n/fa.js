	...
	**/
	...
	$.extend($.jgrid, {
		...
		search: {
			...
			Find: "يافته ها",
			Reset: "از نو",
			odata: [{ oper: 'eq', text: "برابر" }, { oper: 'ne', text: "نا برابر" }, { oper: 'lt', text: "کوچکتر" }, { oper: 'le', text: "کوچکتر مساوی" }, { oper: 'gt', text: "بزرگتر" }, { oper: 'ge', text: " بزرگتر مساوی" }, { oper: 'bw', text: "شروع با" }, { oper: 'bn', text: "شروع نشود با" }, { oper: 'in', text: "عضو این باشد" }, { oper: 'ni', text: "عضو این نباشد" }, { oper: 'ew', text: "اتمام با" }, { oper: 'en', text: "تمام نشود با" }, { oper: 'cn', text: "حاوی" }, { oper: 'nc', text: "نباشد حاوی" }, { oper: 'nu', text: 'is null' }, { oper: 'nn', text: 'is not null' }],
			groupOps: [{
				op: "AND",
				text: "کل"
			},
			...
			operandTitle: "عملگر جستجو را انتخاب کنید",
			matchText: " حاوی",
			rulesText: " اطلاعات"
		},
		edit: {
