...
{
	public class ParserFormula : FacadeEntityBase
	{
		...
		//public static bool DeleteParserFormulasOfSpecificSmsParser(Guid smsParserGuid)
		//{
		//	Business.ParserFormula parserFormulaController = new Business.ParserFormula();
		//	return parserFormulaController.DeleteParserFormulasOfSpecificSmsParser(smsParserGuid);
		//}
	}
}