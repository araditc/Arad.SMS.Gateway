<%@ Page Title="" Language="C#" MasterPageFile="~/HomePages/Arad/Site.Master" AutoEventWireup="true" CodeBehind="BuyPanel.aspx.cs" Inherits="Arad.SMS.Gateway.Web.HomePages.Arad.BuyPanel" %>
							...
							<div class="widget-body">
								<div class="widget-main">
									<h4 class="header red lighter bigger">
										...
										<%=Arad.SMS.Gateway.GeneralLibrary.Language.GetString("BuyPanel") %>
									</h4>
