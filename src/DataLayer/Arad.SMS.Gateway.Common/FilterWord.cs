...
{
	public class FilterWord : CommonEntityBase
	{
		...
		public FilterWord() : base(TableNames.FilterWords.ToString())
		{
			AddField(TableFields.Title.ToString(), SqlDbType.NVarChar, 255);
		}

		public Guid FilterWordGuid
		{
			get
			{
				return PrimaryKey;
