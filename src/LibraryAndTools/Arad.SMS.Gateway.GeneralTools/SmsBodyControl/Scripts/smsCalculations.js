function calculateSmsCount(txtSmsBodyName, smsInfoCellName, characterTitle, smsTitle) {
	...
	smsInfoCell.innerHTML = "&nbsp;" + characterTitle + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + smsLen + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(" + smsCount + ")";
}

function getSmsCount(txtSmsBodyName) {
	var txtSmsBody = $("#" + txtSmsBodyName)[0];
	var standardSmsLen = 160;
	var standardUdhLen = 7;
...
function changeNumber(checkBox, messageBox) { var checked = checkBox.checked; if (checked) { messageBox.value = getArabicNumber(messageBox.value); } else { messageBox.value = getEnglishNumber(messageBox.value); } };
