...
(function ($) {
	...
	$.fn.pagination.defaults = {
		total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, links: 10, layout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "refresh"], onSelectPage: function (_c4, _c5) {
...
(function ($) {
	...
	function _e2(_e3) {
		...
		_e6.find("div.tree-node").draggable({
			disabled: false, revert: true, cursor: "pointer", proxy: function (_e7) {
			...
			accept: "div.tree-node", onDragEnter: function (e, _eb) {
...
(function ($) {
	...
	$.fn.progressbar.defaults = {
		width: "auto", height: 22, value: 0, text: "{value}%", onChange: function (_1da, _1db) {
		}
	};
})(jQuery);
(function ($) {
...
(function ($) {
	...
	$.fn.panel.defaults = {
		id: null, title: null, iconCls: null, width: "auto", height: "auto", left: null, top: null, cls: null, headerCls: null, bodyCls: null, style: {}, href: null, cache: true, fit: false, border: true, doSize: true, noheader: false, content: null, collapsible: false, minimizable: false, maximizable: false, closable: false, collapsed: false, minimized: false, maximized: false, closed: false, tools: null, queryParams: {}, method: "get", href: null, loadingMessage: "Loading...", loader: function (_251, _252, _253) {
			...
			$.ajax({
				type: opts.method, url: opts.href, cache: false, data: _251, dataType: "html", success: function (data) {
					_252(data);
				}, error: function () {
...
(function ($) {
	...
	function _26e(_26f) {
		...
		_270.window.draggable({
			handle: ">div.panel-header>div.panel-title", disabled: _270.options.draggable == false, onStartDrag: function (e) {
				if (_270.mask) {
		...
		_270.window.resizable({
			disabled: _270.options.resizable == false, onStartResize: function (e) {
				if (_270.pmask) {
					_270.pmask.remove();
				}
...
(function ($) {
	...
	function _290(_291, _292, _293) {
		...
		win.window({
			title: _291, noheader: (_291 ? false : true), width: 300, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
				setTimeout(function () {
					win.window("destroy");
				}, 100);
			}
...
(function ($) {
	...
	function _2c5(_2c6, pp, _2c7) {
		...
		pp.panel($.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body" }, _2c7, {
			onBeforeExpand: function () {
	...
	$.fn.accordion.defaults = {
		width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, onSelect: function (_2f1, _2f2) {
...
(function ($) {
	...
	function _323(_324, pp, _325) {
		...
		pp.panel($.extend({}, _325, {
			border: false, noheader: true, closed: true, doSize: false, iconCls: (_325.icon ? _325.icon : undefined), onLoad: function () {
				if (_325.onLoad) {
	...
	$.fn.tabs.defaults = {
		width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_367) {
	...
	function _384(_385, _386, el) {
		...
		if (pp.panel("options").split) {
			...
			_38b.resizable($.extend({}, {
				handles: _38c, onStartResize: function (e) {
					_376 = true;
...
(function ($) {
	...
	function _468(_469) {
		...
		_46a.validatebox($.extend({}, opts, {
			deltaX: $(_469).textbox("getTipX"), onBeforeValidate: function () {
				var box = $(this);
				if (!box.is(":focus")) {
...
(function ($) {
	...
	$.fn.form.defaults = {
		novalidate: false, ajax: true, url: null, queryParams: {}, onSubmit: function (_4d9) {
...
(function ($) {
	...
	function _5a4(_5a5) {
		...
		_5a7.panel($.extend({}, opts, {
			id: null, doSize: false, onResize: function (_5a8, _5a9) {
				setTimeout(function () {
		...
		if (opts.pagination) {
			...
			_5ac.pagination({
				total: (opts.pageNumber * opts.pageSize), pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_5ad, _5ae) {
	...
	function _5b9(_5ba) {
		...
		_5be.each(function () {
			$(this).resizable({
				handles: _5c1, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
					_5bb.resizing = true;
	...
	$.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
		sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_74c, _74d) {
			...
			$.ajax({
				type: opts.method, url: opts.url, data: _74e, dataType: "json", success: function (data) {
					_74f(data);
				}, error: function () {
...
(function ($) {
	...
	function _77f(_780) {
		...
		$(_780).datagrid($.extend({}, opts, {
			cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onClickCell: function (_782, _783, _784) {
				if (_77e != this) {
					_785(_77e);
					_77e = this;
				}
	...
	$.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [[{ field: "f", width: 16, resizable: false }]], columns: [[{ field: "name", title: "Name", width: 100, sortable: true }, { field: "value", title: "Value", width: 100, resizable: false }]], showGroup: false, groupView: _78f, groupField: "group", groupFormatter: function (_7b6, rows) {
			return _7b6;
		}
	});
})(jQuery);
(function ($) {
	function _7b7(_7b8) {
		...
		if (opts.pagination) {
			...
			_7cd.pagination({
				pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_7ce, _7cf) {
	...
	$.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		treeField: null, lines: false, animate: false, singleSelect: true, view: _849, loader: function (_886, _887, _888) {
			var opts = $(this).treegrid("options");
			if (!opts.url) {
				return false;
			}
			$.ajax({
				type: opts.method, url: opts.url, data: _886, dataType: "json", success: function (data) {
					_887(data);
				}, error: function () {
...
(function ($) {
	...
	$.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
		inputEvents: { click: _8a2, keydown: _8a6, paste: _8a6, drop: _8a6 }, panelWidth: null, panelHeight: 200, panelMinWidth: null, panelMaxWidth: null, panelMinHeight: null, panelMaxHeight: null, panelAlign: "left", multiple: false, selectOnNavigation: true, separator: ",", hasDownArrow: true, delay: 200, keyHandler: {
			up: function (e) {
			}, down: function (e) {
			}, left: function (e) {
			}, right: function (e) {
...
(function ($) {
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
		valueField: "value", textField: "text", groupField: null, groupFormatter: function (_919) {
			return _919;
			...
			$.ajax({
				type: opts.method, url: opts.url, data: _91a, dataType: "json", success: function (data) {
					_91b(data);
				}, error: function () {
...
(function ($) {
	...
	$.fn.slider.defaults = {
		width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, value: 0, min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_9e0) {
			return _9e0;
		}, converter: {
