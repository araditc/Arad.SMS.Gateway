<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExtendedPanel.aspx.cs" Inherits="Arad.SMS.Gateway.Web.HomePages.Arad.ExtendedPanel" MasterPageFile="~/HomePages/Arad/Site.Master" %>
							...
							<div class="widget-body">
								<div class="widget-main">
									<h4 class="header red lighter bigger">
										...
										<%=Arad.SMS.Gateway.GeneralLibrary.Language.GetString("ExtendedPanel") %>
									</h4>
									<div class="space-3"></div>
									<asp:Label ID="lblMessage" runat="server" Text="" Style="color: maroon; font-size: large;"></asp:Label>
									<div>
										<%=Arad.SMS.Gateway.GeneralLibrary.Language.GetString("PanelPrice") %>
									</div>
									<div>
										<fieldset>
											<label class="block clearfix">
												<span class="block input-icon input-icon-right">
													<asp:TextBox ID="txtPanelPrice" runat="server" class="form-control input-sm"></asp:TextBox>
